...
def s3_clean_up(s3client, source_bucket_name, file_key_name):
    ...
    if "_wav_standard_cleaned.txt" in file_key_name:
        unrefined_file_name = unrefined_file_name.replace('_wav_standard_cleaned.txt', '.wav')
    elif "_wav_callanalytics_cleaned.txt" in file_key_name:
        unrefined_file_name = unrefined_file_name.replace('_wav_callanalytics_cleaned.txt', '.wav')
    ...
    if "_wav_standard_cleaned.txt" in file_key_name:
        full_transcription_file_name = full_transcription_file_name.replace('_wav_standard_cleaned.txt', '_wav_standard.txt')
        transcription_standard_file_name = transcription_standard_file_name.replace('_wav_standard_cleaned.txt', '_wav_standard.json')
        transcription_callanalytics_file_name = transcription_callanalytics_file_name.replace('_wav_standard_cleaned.txt', '_wav_callanalytics.json')
    elif "_wav_callanalytics_cleaned" in file_key_name:
        full_transcription_file_name = full_transcription_file_name.replace('_wav_callanalytics_cleaned.txt', '_wav_standard.txt')
        transcription_standard_file_name = transcription_file_name.replace('_wav_callanalytics_cleaned.txt', '_wav_standard.json')
        transcription_callanalytics_file_name = transcription_callanalytics_file_name.replace('_wav_callanalytics_cleaned.txt', '_wav_callanalytics.json')
